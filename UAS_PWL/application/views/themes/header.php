    ...
    <nav class="navbar navbar-default navbar-custom navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <!-- GANTI LOGO!!!!!!! -->
          <a class="navbar-brand" href="#"><img src="<?php echo base_url()?>assets/logo1.png"></a>
          <!-- GANTI LOGO!!!!!!! -->
          
        </div>
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">
            <li class="active"><a href="<?php echo base_url()."index.php/shopping"?>">Home</a></li>
            ...
            <li><a href="<?php echo base_url()."index.php/shopping/logout"?>"><i class="glyphicon glyphicon-user"></i> Log Out </a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
